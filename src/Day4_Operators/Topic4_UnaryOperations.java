...
public class Topic4_UnaryOperations {
    public static void main(String[] args) {
        //(+) does not have any effect on the value// 100, + 100, -70
        ...
        int anum4=345;
        anum4=-anum4;
        System.out.println("the value of anum4 is: "+anum4);

        //(++) increase by one
        int anum5=94;
        anum5++; //anum5=anum5+1
        System.out.println("the num5: "+anum5);
++anum5;
        ...
        int anum6 = 36;
        anum6--; //anum6=anum6-1
        System.out.println("the value is: "+anum6);
        --anum6;
        System.out.println("the new result is: "+anum6);
