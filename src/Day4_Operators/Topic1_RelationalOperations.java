...
public class Topic1_RelationalOperations {
    ...
    public static void main(String[] args) {
        ...
        int b = 110;
        boolean bcheck = a == b;
        System.out.println("is a equal to b: "+bcheck);

        boolean bcheck2 = 20 == 20;
        ...
        //"<=" check is one thing is less than another or equal to it
        boolean check5 = 90<=500;
        System.out.println("is 90 less than 500 or equal to 500: "+check5);

boolean check6 = 900<=900;
        System.out.println("result: "+check6);


        //">=" check is one thing is grater than another or equal to it
        ...
        boolean check9 = !(234 != 789);//this is true but we are converting it to the oposite value - false
        System.out.println("the true value:"+check9);
